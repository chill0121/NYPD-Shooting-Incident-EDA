...
- Interestingly, the Covid pandemic did not affect the number of shooting incidents as would be expected.
...
ggplot(covid_months_totals_2, aes(x = DATE, y = n, fill = DATE)) +
    ...
    annotate('label', x = 27.25, y = 125, angle = 90, color = 'darkred', label = 'Covid Pandemic Lockdown Initiated') +
...
- The distribution of shootings in Queens is quite evenly spread, but mostly on the South side.
